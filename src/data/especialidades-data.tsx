...
export const especialidades:arrayEspecialidades = [
    ...
    },
    {
        ...
        descricao: `A córnea é um tecido transparente, fino e resistente localizado na parte anterior do olho. É a primeira 
            ...
            de sua forma ou superfície. Como exemplos podemos: Ceratocone, trauma no olho, infecções, queimaduras por 
            substâncias químicas, enfermidades congênitas ou outras causas em que a pessoa pode ter a visão bastante reduzida ou, 
            às vezes, até perder a visão.
        `,
    },
    {
        nome: "Glaucoma",
    ...
    },
    {
        ...
        imagem: lentesImage,
        resumo: `Lente de contato é uma lente oftálmica corretiva utilizada sobre a córnea. Embora usada principalmente por 
            quem não deseja usar óculos, as lentes de contato podem ser bem indicadas quando existe diferença de grau importante 
            entre os olhos ou uma córnea com irregularidades (como no Ceratocone).
        `,
        descricao: `Lente de contato é uma lente oftálmica corretiva utilizada sobre a córnea. Embora usada principalmente por 
            quem não deseja usar óculos, as lentes de contato podem ser bem indicadas quando existe diferença de grau importante 
            entre os olhos ou uma córnea com irregularidades (como no Ceratocone).
            <br /><br />
            Elas podem ser gelatinosas ou rígidas. Tanto as gelatinosas como as rígidas são feitas com diferentes 
            composições e diferentes métodos de fabricação.

            O exame de refração é o exame realizado para avaliar o erro refrativo ( "grau") apresentado pelo paciente.
            <br /><br />
    ...
    },
    {
        ...
        resumo: `A plástica ocular é uma especialidade da oftalmologia que visa avaliar e se necessário efetuar cirurgias 
            para correções de alterações congênitas (de nascimento) ou adquiridas das pálpebras.
        `,
        descricao: `A plástica ocular é uma especialidade da oftalmologia que visa avaliar e se necessário efetuar cirurgias 
            para correções de alterações congênitas (de nascimento) ou adquiridas das pálpebras.
            <br /><br />
    ...
    },
    {
        nome: "Retina",
        imagem: retinaImage,
        resumo: `A retina é uma camada fina de tecido nervoso sensível à luz localizada no interior do olho. É o tecido que 
            transforma luz em estímulo nervoso e o envia ao cérebro. O tratamento de doenças vítreo-retinianas tem avançado 
            rapidamente nos últimos anos.
        `,
        descricao: `A retina é uma camada fina de tecido nervoso sensível à luz localizada no interior do olho. É o tecido que 
            transforma luz em estímulo nervoso e o envia ao cérebro. O tratamento de doenças vítreo-retinianas tem avançado 
            rapidamente nos últimos anos.
            <br /><br />
            Novas terapias foram introduzidas para tratamento da retinopatia diabética e degenerações retinianas relacionadas 
            com a idade, baseadas em aplicações de medicamentos, associadas ou não ao laser
        `,
    },
    {
        nome: "Trauma Ocular",
        imagem: traumaImage,
        resumo: `Os traumas do globo ocular podem, com maior ou menor intensidade, afetar a córnea, esclera, cristalino, 
            vítreo, retina, coróide, nervo óptico e músculos oculares. Todas estas são estruturas dos olhos e se traumatizadas 
            podem levar a sequelas irreversíveis, tanto na estética quanto na função dos olhos.
        `,
        descricao: `Os traumas do globo ocular podem, com maior ou menor intensidade, afetar a córnea, esclera, cristalino, 
            vítreo, retina, coróide, nervo óptico e músculos oculares. Todas estas são estruturas dos olhos e se traumatizadas 
            podem levar a sequelas irreversíveis, tanto na estética quanto na função dos olhos.
            <br /><br />
            Os traumas podem variar desde queimaduras oculares térmicas ou químicas, hemorragias dentro e fora dos olhos, 
            corpos estranhos na córnea ou dentro dos olhos, perfuração do globo ocular e rupturas dos músculos
        `,
    },
]